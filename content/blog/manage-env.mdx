...
description: env-cmd memungkinkan Anda mengelopokkan environment variables kedalam satu file saja. Anda juga dapat dengan mudah memilih environment mana yang Akan anda gunakan untuk dijalankan di local-machine Anda
date: 2023-03-09
